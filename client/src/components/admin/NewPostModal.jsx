...
export default function NewPostModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Bài viết "${title}" đã được tạo thành công!`);
    setTitle('');
    setSummary('');
    setRawContent('');
    setCoverImage('');
      ...
      >
        <div className="flex items-center justify-between pb-4 border-b border-[#2c2835]">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-display font-bold text-lg text-on-surface">Tạo bài viết mới</h3>
          </div>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div>
            ...
            <input 
              ...
              required
              className="w-full bg-[#15111d] border border-[#2c2835] rounded-xl px-4 py-2.5 text-sm text-on-surface placeholder-on-surface-variant/50 focus:outline-none focus:border-[#4cd7f6] focus:ring-1 focus:ring-[#4cd7f6] transition-all"
            />
          </div>
          ...
          <div>
            ...
            <input 
              ...
              className="w-full bg-[#15111d] border border-[#2c2835] rounded-xl px-4 py-2.5 text-sm text-on-surface placeholder-on-surface-variant/50 focus:outline-none focus:border-[#4cd7f6] transition-all"
            />
          </div>
          ...
          <div>
            ...
            <textarea 
              ...
              rows="3"
              className="w-full bg-[#15111d] border border-[#2c2835] rounded-xl px-4 py-2.5 text-sm text-on-surface placeholder-on-surface-variant/50 focus:outline-none focus:border-[#4cd7f6] transition-all resize-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full bg-[#15111d] border border-[#2c2835] rounded-xl px-4 py-2.5 text-sm text-on-surface placeholder-on-surface-variant/50 focus:outline-none focus:border-[#4cd7f6] transition-all resize-none font-mono text-xs"
            />
          </div>
